...
# Lovable Supabase Sync - Example Project Configuration
# Copy this file to project-config.sh and customize it for your project
...
PROJECT_DESCRIPTION="A project that uses Supabase for backend services"
